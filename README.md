...
1. **[FCI-star](https://www.nber.org/papers/w33952)**<br/>FCI星级
    - *Authors: Ricardo J. Caballero, Tomás E. Caravello, Alp Simsek*
2. **[The Power Asymmetry in Fuzzy Regression Discontinuity Designs](https://www.nber.org/papers/w33972)**<br/>模糊回归不连续设计中的权力不对称
    - *Authors: Daniel Kaliski, Michael P. Keane, Timothy Neal*
3. **[The Political Economy of Stimulus Transfers](https://www.nber.org/papers/w33973)**<br/>刺激转移的政治经济学
    - *Authors: Silvia Vannutelli*
4. **[Firewood in the American Economy: 1700 to 2010.](https://www.nber.org/papers/w33974)**<br/>美国经济中的木柴：1700至2010年。
    - *Authors: Nicholas Z. Muller*
5. **[State of the Art: Economic Development Through the Lens of Paintings](https://www.nber.org/papers/w33976)**<br/>艺术现状：透过绘画镜头看经济发展
    - *Authors: Clément Gorin, Stephan Heblich, Yanos Zylberberg*
6. **[Small Business Innovation Applied to National Needs](https://www.nber.org/papers/w33945)**<br/>小企业创新应用于国家需求
    - *Authors: Kyle R. Myers, Lauren Lanahan, Evan Johnson*
7. **[How Does Wage Inequality Affect the Labor Movement?](https://www.nber.org/papers/w33978)**<br/>工资不平等如何影响劳工运动？
    - *Authors: Barbara Biasi, Zoë B. Cullen, Julia H. Gilman, Nina Roussille*
8. **[Money or Monitoring: Evidence on Improving Worker Effort](https://www.nber.org/papers/w33977)**<br/>金钱还是监督：关于提高工人努力的证据
    - *Authors: Jing Cai, Sai Luo, Shing-Yi Wang*
9. **[Attribute Production and Biased Technical Change in Automobiles](https://www.nber.org/papers/w33979)**<br/>汽车产业的生产属性和技术变革的偏见
    - *Authors: Asa Watten, Soren T. Anderson*
10. **[Coordination and Cooperation](https://www.nber.org/papers/w33980)**<br/>协调与合作
    - *Authors: Pedro Dal Bó, Guillaume Fréchette*
11. **[Do Physicians Follow the Golden Rule? Evidence of Imperfect Agency and Moral Hazard from Physicians’ Self-Prescriptions](https://www.nber.org/papers/w33954)**<br/>医生遵循黄金法则吗？来自医生自我处方的不完全代理和道德风险的证据
    - *Authors: Mariana Carrera, Niels Skipper*
12. **[Private Equity and Workers: Modeling and Measuring Monopsony, Implicit Contracts, and Efficient Reallocation](https://www.nber.org/papers/w33942)**<br/>私募股权与工人：建模与衡量垄断购买力、隐性契约和有效再分配
    - *Authors: Kyle F. Herkenhoff, Josh Lerner, Gordon M. Phillips, Francisca Rebelo, Benjamin Sampson*
13. **[Mergers and Quality Provision in Healthcare: Evidence from Nursing Homes](https://www.nber.org/papers/w33967)**<br/>医疗保健中的合并与质量提供：来自养老院的证据
    - *Authors: Pinka Chatterji, Chun-Yu Ho, Wenqing Li*
14. **[A Macroeconomic Model of Central Bank Digital Currency](https://www.nber.org/papers/w33968)**<br/>一个宏观经济模型中的中央银行数字货币
    - *Authors: Pascal Paul, Mauricio Ulate, Jing Cynthia Wu*
15. **[Accounting Standards and Antidumping Investigations](https://www.nber.org/papers/w33969)**<br/>会计准则与反倾销调查
    - *Authors: Stephen Teng. Sun, Shang-Jin Wei, Jin Xie*
16. **[Economics of Childbearing: Trends, Progress, and Challenges](https://www.nber.org/papers/w33970)**<br/>生育经济学：趋势、进展与挑战
    - *Authors: Martha J. Bailey*
17. **[How the 1942 Japanese Exclusion Impacted U.S. Agriculture](https://www.nber.org/papers/w33971)**<br/>1942年日本排斥对美国农业的影响
    - *Authors: Peter Zhixian Lin, Giovanni Peri*
18. **[Tapping Business and Household Surveys to Sharpen Our View of Work from Home](https://www.nber.org/papers/w33951)**<br/>利用商业和家庭调查来提高我们对居家工作的看法
    - *Authors: Jose Maria Barrero, Nicholas Bloom, Kathryn Bonney, Cory L. Breaux, Cathy Buffington, Steven J. Davis, Lucia S. Foster, Brian McKenzie, Keith Savage, Cristina Tello-Trillo*
19. **[Funding the U.S. Scientific Training Ecosystem: New Data, Methods, and Evidence](https://www.nber.org/papers/w33944)**<br/>资助美国科学培训生态系统：新数据、方法和证据
    - *Authors: Dror Shvadron, Hansen Zhang, Lee Fleming, Daniel P. Gross*
20. **[Financing the Next VC-Backed Startup: The Role of Gender](https://www.nber.org/papers/w33943)**<br/>为下一个风险投资支持的初创公司融资：性别的作用
    - *Authors: Camille Hebert, Emmanuel Yimfor, Heather Tookes*
21. **[Quantifying Racial Disparities Using Consecutive Employment Spells](https://www.nber.org/papers/w33946)**<br/>使用连续就业周期量化种族差异
    - *Authors: Isaac Sorkin*
22. **[Culture, Policy, and Economic Development](https://www.nber.org/papers/w33947)**<br/>文化、政策与经济发展
    - *Authors: Natalie Bau, Sara Lowes, Eduardo Montero*
23. **[A Matter of Time? Measuring Effects of Public Schooling Expansions on Families](https://www.nber.org/papers/w33948)**<br/>时间问题？衡量公立学校扩张对家庭的影响
    - *Authors: Chloe Gibbs, Jocelyn S. Wikle, Riley Wilson*
24. **[Designing Human-AI Collaboration: A Sufficient-Statistic Approach](https://www.nber.org/papers/w33949)**<br/>设计人工智能与人类的合作：一种充分统计量方法
    - *Authors: Nikhil Agarwal, Alex Moehring, Alexander Wolitzky*
25. **[Life Satisfaction in Western Europe and the Gradual Vanishing of the U-shape in Age](https://www.nber.org/papers/w33950)**<br/>西欧的生活满意度与年龄的U形曲线的逐渐消失
    - *Authors: David G. Blanchflower, Alex Bryson*
26. **[Uncertainty through the Production Network: Sectoral Origins and Macroeconomic Implications](https://www.nber.org/papers/w33953)**<br/>生产网络中的不确定性：部门起源与宏观经济影响
    - *Authors: Matteo Cacciatore, Giacomo Candian*
27. **[Maturity Risks and Bank Runs](https://www.nber.org/papers/w33955)**<br/>到期风险与银行挤兑
    - *Authors: Jihene Arfaoui, Harald Uhlig*
28. **[Building Costs and House Prices](https://www.nber.org/papers/w33958)**<br/>建筑成本和房价
    - *Authors: Brian Potter, Chad Syverson*
29. **[The Net Benefits of Raising Bachelor’s Degree Completion through the City University of New York ACE Program](https://www.nber.org/papers/w33956)**<br/>通过纽约市大学ACE项目提高学士学位完成率的净收益
    - *Authors: Judith Scott-Clayton, Irwin Garfinkel, Elizabeth Ananat, Sophie M. Collyer, Robert Paul Hartley, Anastasia Koutavas, Buyi Wang, Christopher Wimer*
30. **[Blockbusters, Sequels and the Nature of Innovation](https://www.nber.org/papers/w33957)**<br/>大片、续集与创新的本质
    - *Authors: Wesley M. Cohen, Matthew J. Higgins, William D. Miles, Yoko Shibuya*
31. **[Net Worth Poverty in Childhood: How Duration and Timing Affect Educational Outcomes](https://www.nber.org/papers/w33959)**<br/>童年时期的净资产贫困：持续时间和时机如何影响教育成果
    - *Authors: Christina M. Gibson-Davis, Lisa A. Keister, Lisa A. Gennetian, Shuyi Qiu*
32. **[Borrowing Constraints, Markups, and Misallocation](https://www.nber.org/papers/w33960)**<br/>借款约束、加成和资源错配
    - *Authors: Huiyu Li, Chen Lian, Yueran Ma, Emily Martell*
33. **[Immigration and Inequality in the Next Generation](https://www.nber.org/papers/w33961)**<br/>下一代的移民与不平等
    - *Authors: Mark Borgschulte, Heepyung Cho, Darren Lubotsky, Jonathan L. Rothbaum*
34. **[Uncertainty in Empirical Economics](https://www.nber.org/papers/w33962)**<br/>实证经济学中的不确定性
    - *Authors: Frank Schorfheide, Zhiheng You*
35. **[A Stairway to Success: How Parenting Shapes Culture and Social Stratification](https://www.nber.org/papers/w33963)**<br/>成功之梯：育儿如何塑造文化和社会分层
    - *Authors: Francesco Agostinelli, Matthias Doepke, Giuseppe Sorrenti, Fabrizio Zilibotti*
36. **[Foreign Political Risk and Technological Change](https://www.nber.org/papers/w33964)**<br/>外国政治风险与技术变革
    - *Authors: Joel P. Flynn, Antoine B. Levy, Jacob Moscona, Mai Wo*
37. **[Common Ownership Around the World](https://www.nber.org/papers/w33965)**<br/>全球共同所有权
    - *Authors: Miguel Antón, Florian Ederer, Mireia Giné, Guillermo Ramirez-Chiang*
38. **[Moment Restrictions for Nonlinear Panel Data Models with Feedback](https://www.nber.org/papers/w33966)**<br/>非线性面板数据模型中反馈效应的矩限制
...
### FCI星级
**[FCI-star](https://www.nber.org/papers/w33952)**
...
**摘要**: 货币政策通过广泛的金融条件—利率、资产价格、信用利差和汇率—而非仅通过政策利率来传导。然而，当前的框架仍然围绕r*，即中性利率。我们引入FCI*，即能够闭合预期产出缺口的金融条件的中性水平，在一个金融条件和宏观经济冲击驱动经济活动具有惯性的框架内。从概念上讲，FCI*反映了宏观经济发展，而不是金融市场估值，使其比响应宏观经济和金融因素的r*更稳定。我们使用Laubach和Williams（2003）的双方程模型，结合1990-2024年的数据估计FCI*。我们的实证估计揭示了三个发现。首先，2008年危机后估计的FCI*保持稳定，而r*由于资产价格下降而持续下降。其次，由于观察到的FCI反映了金融市场冲击，特别是在经济衰退期间，巨大的FCI缺口出现。第三，在货币政策快速变化的时期，FCI缺口更准确地反映了有效的政策立场，因为FCI受到前瞻性市场的驱动；例如，FCI缺口正确地识别了2022年的紧缩，当时利率措施仍表明宽松。

---
### 模糊回归不连续设计中的权力不对称
**[The Power Asymmetry in Fuzzy Regression Discontinuity Designs](https://www.nber.org/papers/w33972)**
...
**摘要**: 在模糊回归不连续性（RD）设计中，当运行变量（R）超过阈值（R0）时，处理的概率会跳跃。通过类似于两阶段最小二乘法（2SLS）的过程获得模糊RD估计，其中指示器I(R > R0)扮演了工具的角色。最近，Keane和Neal（2023, 2024）展示了2SLS t检验存在“功率不对称”问题：当2SLS估计值接近（远离）OLS估计值时，2SLS标准误差会人为地小（大）。在这里，我们展示了模糊RD中出现了类似的问题。因此，如果内生性偏差是正的，模糊RD t检验几乎没有能力检测真实的负效应，并且有过高的能力发现假阳性。即使工具非常强，这个问题仍然存在。为了避免这个问题，应该完全依赖于意向治疗（ITT）回归来评估治疗效果的显著性。

---
### 刺激转移的政治经济学
**[The Political Economy of Stimulus Transfers](https://www.nber.org/papers/w33973)**
...
**摘要**: 在经济衰退期间，刺激转移被广泛使用，但从经济角度来看，它们往往针对性不强。我展示政治激励可能有助于解释这种差异。我研究了意大利最大的刺激税收抵免之一，该抵免排除了最贫穷的个体，针对的是中等收入者。利用接受者份额的准随机地理变化和差异-差异设计，我发现转移使现任政党的投票份额每增加1个百分点的接受者就提高了0.18个百分点。这些收益至少持续五年。在相对富裕的受益地区，政治回报更强，尽管消费反应更弱，选举惩罚排除也是类似的不对称：被排除的高收入个体减少了对现任政党的支持，而较贫穷的被排除个体则没有。当转移被撤销时，选民也会惩罚现任政党，这有助于解释为什么临时项目很少被废除。一个针对较贫穷家庭的反事实转移将使消费反应增加30%，但至少减少15%的选举回报。这些发现突出了刺激设计中的关键政治经济权衡，即选举激励使转移偏向政治反应的接受者，而不是消费反应的接受者。JEL：D72, H23, H53, I38, O15。

---
### 美国经济中的木柴：1700至2010年。
**[Firewood in the American Economy: 1700 to 2010.](https://www.nber.org/papers/w33974)**
...
**摘要**: 尽管木柴在美国早期经济发展中扮演了核心角色，但这种能源燃料的价格在官方政府统计和学术文献中却付之阙如。本文提供了迄今为止编制的最全面的美国木柴价格数据集，涵盖了从1700年到2010年的6000多个价格报价。在1700年到2010年间，实际木柴价格每年增长了0.2%到0.4%，而从1800年到内战期间，实际价格增长尤为迅速，每年增长0.7%到1%。木柴价格上涨和煤炭价格下跌导致了向煤炭作为主要能源燃料的转变。在1860年到1890年间，木柴的收入弹性从0.5变为-0.5。从18世纪末开始，木柴产量从占GDP的大约18%增加到19世纪30年代的近30%。到19世纪80年代，木柴的价值下降到GDP的不到5%。之前对19世纪木柴产量的估计大大低估了其价值。最后，将新的木柴产量估计值纳入农业生产，导致对1860年之前农业生产力增长的估计比文献中先前报告的要高。

---
### 艺术现状：透过绘画镜头看经济发展
**[State of the Art: Economic Development Through the Lens of Paintings](https://www.nber.org/papers/w33976)**
...
**摘要**: 本文分析了从1400年开始的630,000幅画作，以揭示视觉艺术如何反映其社会经济背景。我们开发了一种学习算法，用于预测每幅画作传达的九种基本情感，并分离出一种背景效应——在相同地点和年份创作的艺术作品中共享的情感信号——同时控制艺术家、流派和时代特定影响。这些情感分布编码了微妙但有意义的信息，这些信息反映了艺术作品产生时的生活标准、不确定性或不平等的背景特征。我们提出，这种基于情感的度量，源自历史艺术作品，作为一种新颖的视角，用以检验社会如何经历重大的社会经济转型，包括气候变异、贸易动态、技术变革、知识生产转变和政治过渡。

---
### 小企业创新应用于国家需求
**[Small Business Innovation Applied to National Needs](https://www.nber.org/papers/w33945)**
...
**摘要**: 长期以来，小企业在美国提供了不成比例的主要创新份额。我们回顾了这一主题上的核心政策：美国小企业创新研究（SBIR）计划。我们追溯了其立法历史，并总结了过去四十年的计划评估。利用新匹配的SBIR奖项和对小企业的风险投资数据，我们展示了尽管SBIR支持的企业经常被与风险投资支持的企业相比较，但它们追求的策略却非常不同。我们使用简单的经济理论来激发SBIR计划作为政府投资于小规模、明确但风险大且具有大外部性的技术的工具，我们强调了许多与这一框架一致的案例研究。由于动机摩擦位于思想层面，我们的视角鼓励未来的评估确定SBIR计划如何影响不仅是谁进行发明，还有发明了什么。展望未来，我们讨论了工业集中度的上升和人工智能的扩散如何可能重塑该计划在创新政策工具箱中的比较优势。

---
### 工资不平等如何影响劳工运动？
**[How Does Wage Inequality Affect the Labor Movement?](https://www.nber.org/papers/w33978)**
...
**摘要**: 本文提供了关于职业工资不平等如何影响劳动力流动的第一份因果证据，使用了三种互补的研究设计：与工会组织者进行的情境实验、在2023年美国作家协会罢工期间的信息干预，以及在威斯康星州改革后公共学校教师工资不平等增加的自然实验。在所有研究中，我们发现职业不平等破坏了工会的力量，通过多个渠道。首先，在不平等环境中，具有高个体议价能力的工人更有可能撤回支持，偏好个体而非集体谈判。其次，工会组织者对不平等的战略性反应可能保留了会员资格，但限制了再分配。例如，他们不再以工资为竞选重点，选择更小、更同质的谈判单位。综合来看，我们的发现强调了“不平等陷阱”的可能性，即不断上升的不平等侵蚀了旨在对抗它的机构。

---
### 金钱还是监督：关于提高工人努力的证据
**[Money or Monitoring: Evidence on Improving Worker Effort](https://www.nber.org/papers/w33977)**
...
**摘要**: 更高的薪酬和增加的监督是解决公司与工人之间道德风险问题的两种常见策略。在中国一家汽车制造公司的实地实验中，我们随机变化了签约奖金和监督强度。这两种干预措施都提高了工人的产出，但通过不同的渠道：签约奖金导致工作时间延长，而没有显著提高绩效，而加强监督则提高了经理评估的绩效。此外，奖金降低了离职率，而监督则提高了离职率。这些结果表明，公司在设计最优劳动合同时，应仔细考虑其主要目标，并权衡这些权衡。

---
### 汽车产业的生产属性和技术变革的偏见
**[Attribute Production and Biased Technical Change in Automobiles](https://www.nber.org/papers/w33979)**
...
**摘要**: 近几十年来，汽车变得更大、更快，同时燃油效率也更高。为什么？我们使用1995-2017年美国家庭微观数据估计了一个汽车属性生产的均衡模型，并将属性趋势的结构性分解为潜在机制。我们发现技术变革导致了所有属性的增益。汽油价格上涨提高了效率，但被对尺寸和加速度需求的激增所抵消。效率标准在很大程度上是无效的。我们展示了仅使用技术来满足更严格的标准会使合规成本增加四倍，而从燃油节省技术补贴中获得的效率增益的一半在均衡中被重新分配到其他属性。

---
### 协调与合作
**[Coordination and Cooperation](https://www.nber.org/papers/w33980)**
...
**摘要**: 广泛的实验文献记录了在无限重复博弈中建立合作关系时的协调失误：一些人系统地尝试合作，而另一些人则不这样做。文献在寻找与这些行为系统相关的个人特征方面鲜有成功。我们发现，在简单的协调游戏中选择冒险但效率高的行动的受试者（即，在猎鹿博弈中选择猎鹿）在无限重复博弈中合作的可能性要大得多。这表明，对战略不确定性不太敏感的受试者更有可能尝试建立合作关系。

---
### 医生遵循黄金法则吗？来自医生自我处方的不完全代理和道德风险的证据
**[Do Physicians Follow the Golden Rule? Evidence of Imperfect Agency and Moral Hazard from Physicians’ Self-Prescriptions](https://www.nber.org/papers/w33954)**
...
**摘要**: 利用降胆固醇药物（他汀类药物）的处方数据，我们研究丹麦医生为自己选择的治疗与为患者选择的治疗之间的差异。我们估计医生相对于自己的健康效益，会打折患者的健康效益，如果更强效的他汀类药物是供自己使用，他们会显著更多地重视其额外的效力。我们利用预期共保变化来估计，道德风险只占这种额外评价的一小部分，不超过15%。使用他汀类药物的医生在专利到期时也反应更快，这表明他们更努力地保持对自己个人使用的药品类别的了解。

---
### 私募股权与工人：建模与衡量垄断购买力、隐性契约和有效再分配
**[Private Equity and Workers: Modeling and Measuring Monopsony, Implicit Contracts, and Efficient Reallocation](https://www.nber.org/papers/w33942)**
...
**摘要**: 我们通过构建一个新的数据库，将美国的交易与匹配的雇主-雇员数据联系起来，来衡量私募股权收购对工人结果的真实影响。为了指导我们的实证分析，我们从三种理论中推导出可测试的含义，即私募股权管理者改变工人结果：（1）在集中市场中施加垄断买方力量，（2）违反与目标工人群体的隐性合同，包括管理者和高收入者，以及（3）在工厂之间有效重新分配工人。我们没有发现任何证据表明私募股权支持的公司会根据当地劳动力市场力量的代理来变化工资和就业。管理者和高收入者的工资损失也非常相似。相反，我们发现强有力的证据表明，私募股权管理者相对于生产性工厂，更倾向于缩减生产性较低的工厂，同时将高薪工人重新分配到生产性更高的工厂。我们得出结论，收购后就业和工资动态与专业投资者提供激励以提高生产率并监督他们投资的公司是一致的。

---
### 医疗保健中的合并与质量提供：来自养老院的证据
**[Mergers and Quality Provision in Healthcare: Evidence from Nursing Homes](https://www.nber.org/papers/w33967)**
...
**摘要**: 本文利用1999-2019年的设施级数据，测试了养老院连锁与独立设施之间的合并是否会影响护理质量。错位差异-差异估计表明，被收购设施在合并后两年内健康缺陷引用减少了5%。这种改善依赖于连锁持续提供的效率；持续四年；并且特定于连锁与独立家庭之间的合并。质量效应是由涉及规模较小、质量较高且非私募股权所有的连锁合并所驱动的。结构模型表明，合并后为更多居民提供服务的设施通过提高成本效率来产生质量效应。

---
### 一个宏观经济模型中的中央银行数字货币
**[A Macroeconomic Model of Central Bank Digital Currency](https://www.nber.org/papers/w33968)**
...
**摘要**: 我们构建了一个包含垄断性银行的定量新凯恩斯主义动态随机一般均衡（DSGE）模型，以研究引入中央银行数字货币（CBDC）的宏观经济效应。随着银行存款市场力量的减弱，家庭从流动性服务的扩展和更高的存款利率中受益，而银行的盈利能力和贷款能力下降。我们评估了不同利率水平经济体之间的这种权衡。我们发现，引入CBDC能够带来巨大的福利收益，其最优利率可以通过一个简单的经验法则来近似：0%和政策利率减去1%之间的最大值。

---
### 会计准则与反倾销调查
**[Accounting Standards and Antidumping Investigations](https://www.nber.org/papers/w33969)**
...
**摘要**: 我们发现了一个关于统一会计标准对国际贸易的新真实效应：在强制采用国际财务报告准则之后，那些在报告要求上经历更大变化的出口商在抵御外国反倾销案件方面变得更加成功。这种效应在报告执行更好的国家中也更强，并且在排除非市场经济国家的出口商后依然稳健。我们讨论了全球化会计标准通过减轻进口国的保护主义或遏制出口商的倾销行为，从而促进高效贸易的途径。

---
### 生育经济学：趋势、进展与挑战
**[Economics of Childbearing: Trends, Progress, and Challenges](https://www.nber.org/papers/w33970)**
...
**摘要**: 今年，关于生育的现代新古典经济学迎来了65周年纪念，标志着加里·贝克尔（Gary Becker）在1960年发表的关于该主题的基础性文章的周年纪念。这篇综述文章首先研究了过去一个世纪中，美国生育行为的演变，识别了1960年代后时期的显著特征。接下来，文章讨论了标准的现代新古典生育模型，并展示了通过增加供应侧（包括获取和了解避孕和堕胎的信息）来增强这些模型，从而增强它们的解释力。在回顾了最近使用准实验研究测试这种增强模型的研究之后，文章的最后一部分反思了美国生育率最近的变化对妇女和儿童的影响，并为未来的研究提出了富有成效的途径。

---
### 1942年日本排斥对美国农业的影响
**[How the 1942 Japanese Exclusion Impacted U.S. Agriculture](https://www.nber.org/papers/w33971)**
...
**摘要**: 在20世纪40年代初，日裔美国农民代表了美国西部农业劳动力中技能高超的部分，他们的教育水平和专业化农业知识比美国本土农民更高。在第二次世界大战期间，大约有110,000名日裔美国人（其中包括22,000名农业工人）被强行从西海岸的“禁区”迁移到拘留营。大多数人再也没有回到农业。利用历史农业普查的县级面板数据和三重差分（DDD）估计方法，我们发现到1960年，与非禁区县相比，禁区县的评估农场价值的累积增长每减少一个百分点的1940年日裔农场工人份额，就会降低12%。这些县在农场收入、高价值作物的采纳、机械化和商业肥料的采纳方面也落后。我们提供了更广泛的负面溢出效应对当地经济增长（超出农业部门）的暗示性证据。综合来看，我们的发现强调了这一政策的长期经济成本，说明了失去技能农民如何减少农业增长，并且在快速技术采纳的时代，可能对整个区域发展产生负面影响。

---
### 利用商业和家庭调查来提高我们对居家工作的看法
**[Tapping Business and Household Surveys to Sharpen Our View of Work from Home](https://www.nber.org/papers/w33951)**
...
**摘要**: 对于美国经济而言，及时的、业务层面的远程工作（WFH）的度量指标非常稀缺。我们回顾了以往基于调查的努力，以量化远程工作的发生率和特征，并描述了我们为商业趋势和前景调查（BTOS）开发和实施的新问题。基于超过150,000个公司级别的BTOS回应，我们得到了四个主要发现。首先，近三分之一的企业有员工在家工作，不同行业之间存在巨大差异。信息行业的企业中拥有远程工作员工的比例几乎是住宿和餐饮服务行业的十倍。其次，员工平均每周在家工作大约1天，企业预计五年后远程工作的水平将保持相似。第三，撇开可行性不谈，企业对远程工作的最大担忧与生产力有关。7%的企业认为现场工作更有生产力，而2%的企业认为远程工作更有生产力。第四，对远程工作活动的跟踪和监控水平很低，有70%的企业报告他们不跟踪员工在办公室的天数，75%的企业报告他们不监控在家工作的员工。这些经验教训为增强美国社区调查和其他家庭调查中与远程工作相关的内容包括提供了起点。

---
### 资助美国科学培训生态系统：新数据、方法和证据
**[Funding the U.S. Scientific Training Ecosystem: New Data, Methods, and Evidence](https://www.nber.org/papers/w33944)**
...
**摘要**: 利用自1950年以来收集的关于美国STEM领域博士毕业生的近人口数据，我们检验了谁资助博士培训，有多少毕业生在具有战略国家重要性的领域接受培训，以及公共投资对博士培训对科学劳动力的影响。美国联邦政府远远是美国STEM领域博士培训的最大财政和实物支持来源。我们识别了在哪些大学和领域博士培训有更高或更低的政府、行业或慈善支持强度，以及在人工智能、量子信息技术和生物技术等关键技术领域资助和培训最多博士的组织和大学。利用政府支持在不同机构和时间上的变化，我们提供的证据表明，增加政府资助的博士培训生大致上会一对一地增加博士生产。为了支持进一步的研究，我们提供了多个聚合级别的公共数据集，报告博士毕业生按（i）关键技术领域和（ii）支持来源分类。

---
### 为下一个风险投资支持的初创公司融资：性别的作用
**[Financing the Next VC-Backed Startup: The Role of Gender](https://www.nber.org/papers/w33943)**
...
**摘要**: 性别在风险资本支持的创业公司连续创立中扮演什么角色？尽管有强有力的证据将连续创业与创业成功联系起来，但女性在风险资本支持的创始人中占比为13.3%，而在创立三个或更多创业公司的创始人中仅占4%。通过使用一种新颖的设计，比较同一创业公司的男性和女性联合创始人，我们估计在当前创业公司失败或成功后，随后融资结果的平均值以及在后续融资结果上存在显著的性别差距。我们发现这些差距在广泛和集中的边缘都存在。例如，在失败之后，与男性联合创始人相比，女性创立另一个风险资本支持的创业公司的可能性低22.5%。在那些确实创立了另一个风险资本支持的公司中，女性在当前企业失败后筹集的资本比男性联合创始人少53.3%，在成功后筹集的资本少24.6%。这些差距促成了众所周知的风险资本融资中的性别差距。女性对创立新公司的兴趣较低，只能部分解释我们的发现。我们没有发现创始人质量上的性别差异，也没有发现投资者的统计更新证据。相反，与女性的不平等待遇一致，我们发现女性连续创业者在先前创业失败后，会受到较小的风险资本交易的惩罚，但在过去的成功后并没有获得更大的交易规模的奖励。相比之下，无论他们的创业公司是失败还是成功，男性都会因为他们作为创始人的先前经验而获得奖励。与刻板印象和确认偏误的理论一致，我们还发现在投资者的投资组合中，与女性创立的无关失败有显著的负面溢出效应（以及从他们的成功中没有正面溢出效应）。

---
### 使用连续就业周期量化种族差异
**[Quantifying Racial Disparities Using Consecutive Employment Spells](https://www.nber.org/papers/w33946)**
...
**摘要**: 本文构建了一个框架，用以量化那些不太可能由生产率差异导致的种族间收入和就业差异。在一个就业周期内，雇主会了解工人的生产率，而工人则会转向更高效、偏见更少的雇主。我利用这种行为的含义，将高资历的黑人和白人工人匹配在不可观测因素上。我观察在大规模裁员中失业的匹配对。这些工人在下一份工作中的收入和离职差距不太可能是由于生产率差异造成的。利用美国数据，这些匹配工人之间的收入差异为五个对数点，约占高资历工人种族收入差距的四分之一。同样，匹配的黑人工人更有可能离职。

---
### 文化、政策与经济发展
**[Culture, Policy, and Economic Development](https://www.nber.org/papers/w33947)**
...
**摘要**: 文化塑造了政策的制定方式以及人们对政策的反应。本章探讨了文化与发展政策如何相互影响。首先，我们提供证据表明文化不匹配——特别是项目经理背景与项目实施地点之间的不匹配——与世界银行项目成功率的降低有关。其次，我们借鉴历史和民族志工作，展示了忽视当地文化规范可能会破坏善意的发展政策。第三，我们回顾了经济研究，证明文化实践系统性地塑造了政策的有效性，常常导致异质性或非预期的效果。第四，我们讨论了政策本身可以重塑文化规范的证据，有时以意想不到的方式。最后，我们讨论了针对当地环境量身定制干预措施的研究，并以对未来研究的启示作为结论。

---
### 时间问题？衡量公立学校扩张对家庭的影响
**[A Matter of Time? Measuring Effects of Public Schooling Expansions on Families](https://www.nber.org/papers/w33948)**
...
**摘要**: 我们利用对幼儿公共教育可获得性的显著变化——通过延长幼儿园的时长——来更好地理解隐性儿童保育补贴如何影响母亲和家庭。利用1992年至2022年全日幼儿园变化的空间和时间差异，结合州级政策变化的新数据，并将典型幼儿园年龄儿童与年龄较大的儿童进行比较，我们测量了对父母劳动供给和家庭儿童保育费用的影响。结果表明，家庭对这些变化是敏感的。在这一时间框架内，全日幼儿园的扩展对幼儿园适龄儿童母亲的就业增长贡献了高达24%。

---
### 设计人工智能与人类的合作：一种充分统计量方法
...
**摘要**: 我们提出了一个充分统计量，用于设计人工智能信息披露和选择性自动化政策。这种方法允许内生和有偏见的信念，以及努力挤出效应，而无需使用人类决策的结构模型。我们在事实核查实验中部署并验证了这种方法。人类对人工智能预测的反应不足，并在面对自信的人工智能预测时减少努力。过度自信于自己的信号，而不是对人工智能的不信任，推动了对人工智能反应不足。最优政策是在人工智能自信的情况下自动化决策，并将其他决策委托出去，同时完全披露人工智能预测。尽管自动化有价值，但用人工智能协助人类的好处可以忽略不计。

---
### 西欧的生活满意度与年龄的U形曲线的逐渐消失
**[Life Satisfaction in Western Europe and the Gradual Vanishing of the U-shape in Age](https://www.nber.org/papers/w33950)**
...
**摘要**: 利用1973年以来21个西欧国家的欧洲晴雨表数据，我们展示了长期以来存在的年龄与生活满意度之间的U型关系现在已经消失。在13个北欧国家——比利时、丹麦、芬兰、德国、冰岛、爱尔兰、卢森堡、荷兰、挪威、瑞典、瑞士、土耳其和英国——U型关系已经被随着年龄增长而提高的生活满意度所取代。我们通过欧洲社会调查、全球繁荣调查和全球心智调查的证据证实了这些发现。奥地利和法国U型变化的证据是复杂的。在六个南欧国家——塞浦路斯、希腊、意大利、马耳他、西班牙和葡萄牙——U型关系被随着年龄增长而降低的生活满意度所取代。在这些南欧国家，年轻人的生活满意度自2015年左右以来一直在上升。一个促成因素是青年失业率从2015年的峰值迅速下降。

---
### 生产网络中的不确定性：部门起源与宏观经济影响
**[Uncertainty through the Production Network: Sectoral Origins and Macroeconomic Implications](https://www.nber.org/papers/w33953)**
...
**摘要**: 我们研究了不确定性是如何通过生产网络传播的。首先，我们利用美国公司的期权隐含波动率数据构建了一个高度细分的、前瞻性的行业层面不确定性度量。其次，我们识别了行业内、供应链中以及总体层面上更高不确定性的影响。我们发现，上游行业（例如，化学制造、钢铁厂）的不确定性增加表现为负面供应冲击——提高了整个生产网络的价格并降低了就业。相比之下，下游行业（例如，汽车制造、保险公司）的不确定性增加表现为不利的需求冲击，既降低了价格也降低了就业。在总体层面，通胀反应取决于不确定性在供应链中的起源位置。一个具有时变部门不确定性的多部门模型表明，生产联系在解释这些实证发现中起着核心作用。

---
### 到期风险与银行挤兑
**[Maturity Risks and Bank Runs](https://www.nber.org/papers/w33955)**
...
**摘要**: 受硅谷银行挤兑事件的启发，并在Diamond-Dybvig（1993年）的基础上，我们构建了一个模型，其中资产价格波动可能引发银行挤兑。清算意味着以市场价格出售资产。存款人支付特定成本后可以购买并持有这些资产。我们对均衡状态进行了描述。我们引入了一个取款压力函数，以区分由市场价格下跌驱动的基本挤兑和由存款人恐慌引发的自我执行挤兑。存款保险可以阻止自我执行挤兑，但在基本挤兑期间会产生损失。确保价格韧性的监管措施可以降低挤兑风险，但以牺牲存款人福利为代价。

---
### 建筑成本和房价
**[Building Costs and House Prices](https://www.nber.org/papers/w33958)**
...
**摘要**: 我们对美国房地产市场建筑成本与房价之间的联系持一种长期、广泛且理论上不偏不倚的观点。我们发现，建筑成本从未对美国房价有过太大的解释力，但即使是过去不完美的相关性，在近几十年来也在多个维度上进一步减弱。

---
### 通过纽约市大学ACE项目提高学士学位完成率的净收益
**[The Net Benefits of Raising Bachelor’s Degree Completion through the City University of New York ACE Program](https://www.nber.org/papers/w33956)**
...
**摘要**: 2015年，纽约市立大学（CUNY）启动了一个新的项目——加速、完成和参与（ACE），旨在提高大学毕业生的毕业率。对该项目进行的随机对照评估发现，与大学入学后五年的毕业率相比，该项目使毕业率提高了近12个百分点。利用这一影响估计以及按性别、年龄和学位状况划分的国家收入数据，我们估算了参与者相对于控制组“一切照旧”情况下的增量预期长期收益和成本，以及对参与者子女的代际效应。我们的主要估算显示，每位参与者一生中的净社会收益超过48,000美元，这来自于更高的收入和劳动力参与度、健康改善以及公共转移支付的节省。我们分析的一个主要贡献是估算第二代效益。将新一代效益包括在内，对于在新的高收入家庭中长大的儿童，这一估计几乎增加了三倍，达到每位参与者超过130,000美元的净社会收益。这些结果对假设五年后对毕业的影响是否无限期持续，或者控制组最终是否迎头赶上的假设很敏感。尽管如此，即使在我们最保守的假设下，净社会收益也明显是正的。

---
### 大片、续集与创新的本质
**[Blockbusters, Sequels and the Nature of Innovation](https://www.nber.org/papers/w33957)**
...
**摘要**: 利用制药行业的详细产品和发明层面数据，我们展示了那些拥有特别畅销的“重磅炸弹”产品的公司，将他们的开发工作集中在新产品上，这些新产品既针对相同的客户群体，也更有可能在技术上与现有的重磅炸弹产品相似。这种行为是由对现有产品需求粘性的预期所驱动的，限制了公司投资于完全针对不同客户群体的全新产品的动机。我们的发现为理解重磅炸弹产品如何塑造公司的客户细分和创新选择提供了洞见，对于理解研发密集型行业中技术变革的动态具有重要意义。

---
### 童年时期的净资产贫困：持续时间和时机如何影响教育成果
**[Net Worth Poverty in Childhood: How Duration and Timing Affect Educational Outcomes](https://www.nber.org/papers/w33959)**
...
**摘要**: 家庭财富极低，或净资产贫困（NWP），是美国儿童贫困的主要形式，但人们对其在儿童时期的经历以及与儿童人力资本积累的关系知之甚少。利用1999-2021年波次的收入动态小组研究数据，本研究考察了儿童从出生到20岁期间NWP暴露和持续时间对其高中辍学和大学入学的影响。研究结果表明，到18岁时，儿童经历的净资产贫困比收入贫困更为频繁且持久。NWP与高中辍学和大学入学呈负相关，与收入贫困的影响无关。对于大学入学的影响比高中辍学更为显著，这可能反映了大学教育的资源密集性质。对于样本中至少有四个波次NWP的31%，NWP的负面影响最为显著。NWP的时机相对于发展阶段似乎并不重要，因为无论儿童在哪个年龄经历净资产贫困，他们都处于风险之中。

---
### 借款约束、加成和资源错配
**[Borrowing Constraints, Markups, and Misallocation](https://www.nber.org/papers/w33960)**
...
**摘要**: 我们记录了将公司加价与借款约束联系起来的新事实：（1）在资产难以作为借款抵押且公司更多依赖收益进行借款的行业中，约束较少的公司具有更高的加价；（2）在公司更多依赖收益进行借款的行业中，加价的分散度也更高。我们使用一个标准的金博尔需求模型，通过增加对资产和收益的借款来解释这些关系。关键机制是加价和借款约束之间的双向反馈。首先，约束较少的公司收取更高的加价，因为更宽松的约束使它们能够获得更大的市场份额。其次，当公司依赖收益进行借款时，更高的加价会放松借款约束，因为那些加价更高的公司拥有更高的收益。这种双向反馈降低了由于加价分散导致的全要素生产率损失，特别是当公司依赖收益进行借款时。

---
### 下一代的移民与不平等
**[Immigration and Inequality in the Next Generation](https://www.nber.org/papers/w33961)**
...
**摘要**: 我们估计了移民对美国城市中在美国出生的父母的孩子的代际经济流动性的因果影响。移民提高了在较贫困家庭中长大的个体的教育水平和收入，并降低了在更富裕家庭中长大的个体的收入、教育水平和就业。总体而言，移民减少了接收人口中父母和子女经济结果之间的联系，从而增加了代际流动性。在不同城市估计的模型中，以及在控制移民目的地轨迹的城市内部模型中，流动性的增加惊人地相似。

---
### 实证经济学中的不确定性
**[Uncertainty in Empirical Economics](https://www.nber.org/papers/w33962)**
...
**摘要**: 计量经济学家投入大量精力构建标准误差，以期在假设的数据生成过程中得出有效的推断。本文提出了一个基本问题：应用研究者报告的不确定性陈述是否与经验频率一致？简短的答案是否定的。借鉴预测文献，我们使用对应基线研究的估计值来预测“新”研究的估计值。通过在大量研究组中这样做，并通过层次模型链接参数，我们比较了声明的概率与观察到的经验频率。只有在有限的外部有效性下，即研究估计不同的参数时，对齐才会发生。

---
### 成功之梯：育儿如何塑造文化和社会分层
**[A Stairway to Success: How Parenting Shapes Culture and Social Stratification](https://www.nber.org/papers/w33963)**
...
**摘要**: 本章认为，父母的选择是文化和经济结果共同演变中的一个核心力量。我们提出了一个框架，其中父母出于对孩子未来成功的期望和自己的规范信念，选择育儿方式并传递文化特征，以响应经济激励。当工作伦理、耐心和宗教信仰等价值观的预期回报，无论是经济上的还是其他方面的，都很高时，它们更有可能被灌输。育儿与经济条件之间的相互作用导致了内生的文化和经济分层。我们将模型扩展到包括居住区划分和社交互动，展示了邻里选择如何加强信任和人力资本的差异。来自世界价值观调查的实证证据支持了模型的关键预测。我们最后强调了育儿、文化和不平等交叉点上的开放性问题。

---
### 外国政治风险与技术变革
**[Foreign Political Risk and Technological Change](https://www.nber.org/papers/w33964)**
...
**摘要**: 本文研究了创新如何对外国政治风险做出反应，并塑造其经济后果。在一个包含可能破坏外国投入品供应的外国政治冲击的模型中，我们展示了国外更大的政治风险会增加国内创新，从而降低对风险采购国家的依赖。然后，我们将行业层面的技术发展数据与行业层面对外国政治风险暴露的时间变化度量相结合，并报告了三组实证结果。首先，对外国政治风险暴露度更高的行业和商品表现出显著更大的创新活动。这一发现在美国各行业、全球样本中的国家-行业对以及对现代经济活动至关重要的关键矿产中都成立。其次，当风险来自地缘政治对手时，创新的响应尤其强烈。这与我们的发现一致，即在任一国家政治风险上升后，非盟友之间更有可能产生贸易限制。第三，定向创新减少了国家对来自风险外国市场的进口的依赖。在此过程中，技术变革放大了国内政治风险对出口表现的负面影响。

---
### 全球共同所有权
**[Common Ownership Around the World](https://www.nber.org/papers/w33965)**
...
**摘要**: 我们研究了2005年至2019年49个国家的共同所有权，并表明它在全球普遍存在且呈上升趋势。然而，尽管全球范围内的增长，与美国相比，所有国家的共同所有权仍然显著较低。在最大的公司中，共同所有权尤其高且增长迅速，这一趋势在所有国家和地区都能观察到。共同所有权的上升不仅源于机构投资的增加，还源于其集中度的增长，其中“三大”（贝莱德、先锋、道富）在美国扮演了主导角色。尽管非三大机构投资者在其他国家仍然重要，但许多国家共同所有权的显著增加主要归因于三大持有的广泛性、规模和增长。我们还研究了共同所有权与法律、制度和市场特征之间的关系，如投资者保护法、竞争法、强制性ESG披露以及跨国公司和国家的劳动力市场摩擦。

---
### 非线性面板数据模型中反馈效应的矩限制
**[Moment Restrictions for Nonlinear Panel Data Models with Feedback](https://www.nber.org/papers/w33966)**
...
**摘要**: 许多面板数据方法虽然允许协变量和时间不变个体特定异质性之间存在一般依赖性，但对反馈施加了强烈的先验限制：过去的结果、协变量和异质性如何映射到未来的协变量水平。在许多动态经济环境中，完全排除反馈，如实践中经常发生的那样，是不可取的。我们为非线性面板数据模型提供了所有反馈和异质性稳健（FHR）矩条件的一般特征描述，并提出了推导特定模型可行的基于矩的估计器的构造性方法。我们还利用我们的矩特征来计算半参数效率界限，允许量化适应反馈时与信息损失相关的量，同时提供如何在实践中构建具有良好效率属性的估计器的见解。我们的结果既适用于有限维参数，也适用于涉及对未观察到的异质性分布的平均值的估计量。我们通过提供多时点混合比例风险模型中所有FHR矩函数的完整特征描述来说明我们的方法。我们为该设置中的模型参数和平均效应计算了有效的矩函数。
