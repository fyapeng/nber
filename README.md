...
4. **[Long-term Vertical Contracts, Geography, and the Persistence of Brand Shares](https://www.nber.org/papers/w33906)**<br/>长期纵向合同、地理因素和品牌份额的持续性
...
13. **[Defaulting 401(k) Assets into Payout Annuities for “Pretty Good” Lifetime Incomes](https://www.nber.org/papers/w33915)**<br/>将违约的401(k)资产转换为支付年金，以获得“相当不错”的终身收入
...
19. **[The Neoclassical Theory of Firm Investment and Taxes: A Reassessment](https://www.nber.org/papers/w33922)**<br/>新古典企业投资与税收理论的重新评估
...
21. **[Like Great-Grandparent, Like Great-Grandchild? Multigenerational Mobility in American History](https://www.nber.org/papers/w33923)**<br/>像曾祖父母一样，曾孙辈也如此？美国历史上的多代际流动性
...
24. **[Does Matching Contribution Incentivize Informal Workers to Participate in Retirement Saving Plans? A Randomized Evaluation Interacted with a Natural Experiment](https://www.nber.org/papers/w33925)**<br/>匹配贡献是否激励非正规工人参与退休储蓄计划？一个与自然实验相结合的随机评估
...
**摘要**: 我们考虑在线平台使用人工智能（AI）在社交媒体内容传播、娱乐或电子商务中的政治后果。我们识别出两个不同但互补的机制，社交媒体渠道和数字广告渠道，它们共同和单独地促进了选民的两极分化，进而导致政党的两极分化。首先，旨在最大化用户参与度的AI驱动推荐在平台上创造了回音室（或“过滤泡泡”），增加了个体不接触反态度内容的可能性。因此，社交媒体参与使选民更加两极分化，然后政党通过自身变得更加两极分化来做出回应。其次，我们展示了政党竞争可以鼓励平台更多地依赖针对性数字广告进行货币化（而不是基于订阅的商业模式），而这种广告反过来使选民更加两极分化，进一步促进了政党的两极分化。当一个政党占主导地位时，这些效应不会出现，在这种情况下，平台的利润最大化商业模式是基于订阅的。我们讨论了监管对AI驱动的在线平台两极分化效应的影响。
...
**摘要**: 自18世纪以来，政策制定者一直在讨论产业政策（IP）的优点。然而，由于测量挑战，经济学家缺乏关于其使用的基本事实。我们提出了一种基于政策文本中信息的新的产业政策测量方法。我们展示了如何使用现成的监督机器学习工具来大规模分类产业政策。利用这种方法，我们验证了对早期测量方法的长期担忧，这些方法将IP与其他类型的政策混为一谈。我们将我们的方法应用于全球商业政策描述数据库，并首次在国家、行业和年份层面（2010-2022年）查看IP的使用情况。新的IP数据显示：i）IP正在上升；ii）现代IP倾向于使用补贴和出口促进措施，而不是关税；iii）富裕国家在IP使用上占据主导地位；iv）IP倾向于针对具有既定比较优势的行业，特别是在高收入国家。
...
**摘要**: 在推翻罗伊诉韦德案并触发许多州禁止或严格限制堕胎的法律后，最高法院在2022年具有里程碑意义的多布斯决定极大地改变了美国生殖健康的局面。先前的研究强调了堕胎限制对妇女和家庭的深远影响，这些影响超出了对堕胎、出生和生育能力的直接影响。我们提供了一些最早的因果证据，说明在多布斯时代之后堕胎限制如何影响女性遭受亲密伴侣暴力（IPV）的风险。IPV是女性经历的最常见暴力形式，获取堕胎途径的变化可能会对各种输入（经济资源、压力、家庭内部议价）产生意外影响，这些影响可能会影响关系动态并增加IPV的风险。利用2017-2023年向执法部门报告的IPV事件信息，结合多布斯之后县级前往堕胎设施的旅行距离变化，分析基于广义差异-差异方法。我们发现，通过增加旅行距离和通过存在近全面禁令来衡量的堕胎限制显著增加了受治疗县级生育年龄女性的IPV率，大约增加了七到十个百分点。这些估计意味着在受治疗的“触发禁令”州，女性IPV事件至少增加了9000起，预计将增加超过12.4亿美元的社会成本。

---
### 长期纵向合同、地理因素和品牌份额的持续性
...
**摘要**: 先前的研究强调了由于地理消费者偏好和早期进入优势，各地区国家品牌市场份额持续存在差异（Bronnenberg等人，2007年，2009年）。本研究调查了长期纵向合同能在多大程度上解释观察到的地理分散和国家品牌主导地位的持续性。使用与Bronnenberg等人（2007年）相同产品类别的NielsenIQ数据，我们遵循Abowd等人（1999年）的方法，将品牌份额的方差分解为品牌×零售商和品牌×市场效应。结果显示，50%的方差由零售商效应解释，而市场效应解释了20%。这表明一些零售商使用纵向合同来支持他们在所有竞争市场中的特定品牌，例如独家交易、货架津贴或品类队长合同，这些在维持先前文献中记录的国家品牌主导地位中发挥了关键作用。通过强调零售商特定因素如何推动观察到的模式，我们补充了需求侧解释，并将注意力转移到可能影响竞争的供给侧因素上。
...
**摘要**: 在近期关于知识创造和创新的文献基础上（特别是Carnehl和Schneider（2025年）的研究），我们提出了一个新颖的一般均衡模型，该模型明确将人工智能（AI）纳入作为一个能够插值已知知识点之间空白的决策增强技术。我们的框架形式化了AI覆盖范围——其跨越更广泛知识差距的能力——与其准确性之间的权衡，并揭示了一个令人惊讶的结果：除了产生直接的生产力增长外，AI从根本上改变了研究的新颖性。具体来说，当AI系统提供足够广泛的覆盖范围时，它们激励探索性研究，深入挖掘新颖、遥远的知识领域，并加速长期增长；相反，有限的覆盖范围促进了增量研究，这可能会提高短期效率，同时抑制新思想的整体发展。此外，我们的分析揭示了知识类型——无论是新颖的还是密集的——在决定AI的增长和福利影响方面发挥着关键作用，为理解知识如何影响研究策略开辟了新路径。通过同时考察市场结构、许可安排和监管框架的作用，我们的工作提供了新的、与政策相关的见解，协调了AI采纳的即时效益与可持续长期经济增长的需求。
...
**摘要**: 发展过程伴随着劳动力市场结构的显著变化。我们概述了一系列区分发展中国家劳动力市场与富裕国家劳动力市场的典型特征。我们的回顾围绕一个特别引人注目的差异展开：在贫穷国家，工作年龄的个体只有20-50%的时间从事有薪工作。有证据表明，这种低薪就业反映了高比例的非自愿失业（通常被自雇所掩盖），以及工资刚性、市场力量和搜索与匹配摩擦等摩擦。与此同时，越来越多的文件记录显示，工人更倾向于自雇或失业，而不是他们可获得的许多有薪工作，特别是正规部门的低技能工作。我们提供了一些证据，说明贫困本身如何抑制劳动力供给，以至于“低”劳动力供给本身可能是欠发展的一个结果。在我们的回顾中，我们强调了贫困的三个核心方面——市场的缺失、社会联系的重要性和制度的不规则性——对于理解发展中国家劳动力市场为何可能与富裕国家的劳动力市场表现不同非常重要。这对于理解劳动力市场如何响应发展过程以及如何帮助促进发展过程具有相关性。
...
**摘要**: 我们研究了GDPR如何影响跨大西洋的风险投资。通过分析2014年至2019年的投资数据，我们发现2018年5月GDPR的实施导致美国投资者在欧盟的活动显著下降，这体现在交易数量和投资额减少，尤其是对于新兴和与数据相关的企业。投资者转向地理上更接近的企业，并更多地依赖于联合投资，特别是与欧盟领先的投资者合作。尽管转向本地投资推动了整体下降，但联合投资部分抵消了这一趋势。研究结果强调了数字政策在塑造投资策略和影响跨大西洋资本流动中的作用。
...
**摘要**: 本研究考察了2006年至2018年间加拿大野火与心理健康相关住院之间的关系。大多数先前对野火心理健康成本的估计都集中在暴露于PM₂.₅的影响上。我们通过强调野火影响心理健康的其他途径，包括疏散命令、火灾的直接本地成本和气候焦虑（使用与野火相关的推特活动作为代理），从而开辟了新的研究领域。我们发现，所有这些机制都影响心理健康相关的住院，尤其是对焦虑和药物滥用的住院影响尤为显著。在空气质量的条件下，引起全国关注的野火事件会恶化易感人群的心理健康，即使他们居住在远离野火的地方。老年人和那些有先前健康状况使他们更脆弱的人受到的影响更大。结果表明，由野火事件引发的气候焦虑可能占整体心理健康成本的很大一部分。然而，考虑到这些额外的机制对野火烟雾中PM₂.₅的估计效应几乎没有减少，这表明这些额外因素对心理健康的影响是除了PM₂.₅之外的。
...
**摘要**: 当更具歧视性且不那么慷慨的学生系统性地选择某些领域、课程和教师部分时，应如何解决性别歧视和系统性劣势问题？在本文中，我们通过检查学生对男性和女性教师的评价差异，并控制教授固定效应，来估计学生层面的性别偏见和评估慷慨度的度量。在考虑测量误差的情况下，我们发现学生之间的性别偏见和慷慨度存在显著差异。此外，我们发现偏见会根据性别和学习领域系统性地变化，并且排序模式足够大，以至于在某些领域使女性教师处于实质性劣势，而在其他领域使男性教师处于劣势。最后，我们记录了性别歧视态度可以预测基于性别的排序，并提出了受经验贝叶斯启发的学生层面偏见度量，以纠正由排序引起的教师特定优势和劣势。
...
**摘要**: 本文考察了在广泛的随机搜索工作阶梯模型中，去中心化均衡的效率。我们将效率低下的来源分解为两个方面：（i）投资边际，即在给定匹配剩余的情况下，创造就业的私人和社会利益之间的差异；（ii）估值边际，即匹配剩余的私人估值和社会估值之间的差异。在存在在职搜索的情况下，众所周知的Hosios条件不再保证市场均衡与有效分配在这两个边际上一致。在职搜索导致市场均衡中对匹配剩余的高估，特别是在工作阶梯的顶端。因此，在Hosios条件下的去中心化均衡表现为稳态中空缺创造过多。在职搜索还导致对总体生产率冲击的失业波动过大。从数量上看，我们发现在标准校准下，均衡结果与有效分配之间存在显著差异。我们还考虑了几种有效分配的去中心化，以阐明在摩擦性劳动市场中的最佳政策。
...
**摘要**: 全球的出生率都在下降，每个地区都不例外。下降的出生率可以分解为两个组成部分：（1）无子女现象的增加（即终身未生育），以及（2）至少生育过一个孩子的女性生育的孩子数量减少（已生育女性的完成队列生育率）。本文量化了这两个组成部分对于欧洲、北美和南美以及东南亚的发达经济体中的女性，以及印度各区近期队列的贡献。在两个样本中，我们都发现，已生育女性的生育率是解释低总体出生率的一个重要组成部分。在我们的分析中，无子女现象仅解释了发达经济体队列生育率下降的38%。在印度背景下，无子女现象仅占高生育率和低于替代水平地区之间差异的6%。此外，在许多国家队列和印度地区，即使只考虑有孩子的女性，即从平均数中省略零值，平均完成的队列生育率也会低于替代阈值。这与广泛流传的近期叙述相抵触，这些叙述将出生率下降归因于无子女现象的增加：相反，在许多人群中，即使是父母的平均水平生育率也足够低，最终会导致人口减少。
...
**摘要**: 2017年的《减税与就业法案》（TCJA）标志着三十年来首次对美国公司税法进行了实质性的修改。我们利用TCJA作为一个准自然实验，来估计资本使用成本变化对投资的影响。按照Auerbach和Hassett（1991年）的方法，我们使用横截面数据发现，资本使用成本与更高的投资率相关，这与以往的研究一致。在2017年TCJA之后，美国经济分析局（BEA）的资产类型中，资本使用成本和边际有效税率（METR）的降低幅度更大的资产类型，在税改几年后其投资率的增长更为显著。具体来说，我们发现资本使用成本每降低1个百分点，与投资率增加1.68至3.05个百分点相关联，这一数值大于之前对投资对资本使用成本响应度的估计。

---
### 将违约的401(k)资产转换为支付年金，以获得“相当不错”的终身收入
...
**摘要**: 一些美国的固定缴款计划为退休人员提供了从他们的401(k)账户中选择年金或终身收入流作为支付选项的机会。然而，由于行为原因，一些退休人员可能会犹豫选择终身收入流作为提取工具。为了解决这个问题，计划发起人可以自动将退休人员的401(k)资产的一部分分配给年金，因为现在这样做的监管障碍已经减少。我们使用一个生命周期经济模型来评估将退休人员的401(k)资产默认为支付年金的利弊。我们展示，将退休人员资产的20%超过一定门槛的部分默认为立即年金，可以增强大多数计划参与者的退休安全。对于大学毕业生来说，推迟到80岁时的年金尤其有益，这可以增强他们的福利。
...
**摘要**: 青少年心理健康危机与高比率的青少年尼古丁电子烟使用现象的汇合，导致一些美国烟草控制倡导者认为，通过政策如电子尼古丁输送系统（ENDS）征税来减少对ENDS的获取，可能会改善青少年和年轻成年人的心理健康。利用来自几个全国代表性调查（青少年风险行为调查、行为风险因素监测系统和烟草与健康人群评估）的数据和广义差异-差异方法，我们发现没有证据表明ENDS征税改善了青少年和年轻成年人的心理健康。我们有95%的信心排除，在我们的分析样本期间采用的平均州ENDS税收增加（2023年每毫升电子液体0.34美元）将青少年持续抑郁症状减少超过0.3%，自杀念头减少超过1.0%的可能性。此外，离散时间风险模型提供的证据很少，表明ENDS税收影响青少年心理健康的动态。当我们检查更广泛的ENDS法规时，类似的结果模式出现，包括最低法定购买年龄、电子烟许可法律、在线销售限制和室内尼古丁电子烟限制。
...
**摘要**: 本文分析了美国带薪家庭假（PFL）政策对中年和老年残疾人非正式和正式护理的影响，以及不同家庭如何获得不同的异质性福利。我们使用了1998-2018年健康和退休研究（HRS）的数据，并利用加利福尼亚（2004年）、新泽西（2009年）和纽约（2018年）实施的PFL计划，在差异中的差异（DiD）设计中进行分析。我们既采用了传统的双向固定效应（TWFE）模型，也采用了孙和亚伯拉罕为交错推出设计开发的适应性DiD估计器。我们发现，PFL的获取与残疾人从子女那里获得非正式护理的可能性增加了5.7个百分点。我们还展示了PFL的获取显著增加了家庭护理服务和养老院护理的使用。这些影响主要集中在既有配偶又有子女的残疾人中，而在只有子女没有配偶的人中几乎不存在。我们的发现表明，PFL政策改善了护理获取，并帮助解决了中年和老年残疾人的未满足护理需求，但其对某些脆弱子群体的影响仍然有限，特别是那些只有子女的人。
...
**摘要**: 大数据和算法的创新使得以大规模为目标的干预措施有了新的方法。我们比较了三种不同系统在识别贫困人群以接收福利转移方面的准确性——代理手段测试、社区成员提名，以及使用机器学习预测贫困的算法方法，该方法基于手机使用行为——并研究它们的成本效益如何随着项目规模和范围的变化而变化。我们收集了孟加拉国所有主要电信运营商的手机记录，并进行了基于社区的财富排名和对5000户家庭的详细消费调查，以从106000户列出的家庭中选出22000户最贫困家庭，为他们提供300美元的转移支付。虽然代理手段测试最准确，但在需要筛选大量家庭的国家规模项目中，算法定位变得更加具有成本效益。我们使用多哥的调查数据和手机记录数据，以及世界银行关于福利转移项目跨国信息，探索这些见解的外部有效性。
...
**摘要**: 在本文中，我们讨论了遗产和其他代际转移以及它们对家庭的消费、储蓄和劳动力供应行为的影响。我们展示了遗产和其他代际转移在大多数国家普遍存在，它们有时是出于利他主义的动机，有时是出于自私的动机，它们在一定程度上影响家庭的消费和储蓄行为，特别是老年家庭的行为，它们影响家庭的劳动力供应行为，尤其是遗产接受者的行为，并且它们具有重要的政策含义。
...
**摘要**: 社会期望偏差（SDB）是对调查和实验数据有效性的普遍威胁。受访者可能会误报敏感的态度和行为，以显得更符合社会接受度。我们首先综合实证证据，分析SDB在不同领域的普遍性和程度，重点关注具有个体水平基准的研究。然后，我们批判性地评估常用的减轻SDB的策略，强调它们有时可能因造成混淆或无意中增加感知的敏感性而失败。为了帮助研究人员应对这些挑战，我们提供实用的指导，以选择不同研究情境中最合适的工具。最后，我们检查SDB如何在实验中扭曲治疗效果，并讨论减轻策略。
...
**摘要**: 经济学家对于公司税收如何影响总体投资、产出和工资的看法大相径庭。这种分歧反映了60年来对新古典投资理论的误用历史，这种误用被用来解释实证工作并指导政策分析。在本文中，我通过新古典理论的视角重新审视了累积的证据，这些证据将税收政策与公司投资联系起来。实证研究表明，公司层面、短期的半弹性投资与资本比率对用户成本的范围为-0.25至-0.75。这个范围的中点转化为公司收入对资本的弹性值在0.22到0.35之间。隐含的一般均衡、长期资本对用户成本的弹性可能与主要政策模型大相径庭。工资对用户成本的弹性范围为-0.3至-0.7，或者仅对C型公司部门用户成本变化时为-0.1至-0.2。在2024年美国相对较低的税收制度下，新古典对更高产出的贡献无法合理化通过进一步降低公司税收来获得更多的动态税收收入抵消，这种抵消只能是有限的。
...
**摘要**: 大学学位为低收入学生提供了一条通往经济流动性的途径。通过使用多地点随机对照试验以及行政和调查数据，我们证明了在高中和大学期间进行密集的咨询显著提高了低收入学生获得学士学位的比例。我们利用关于咨询前大学偏好的独特数据和因果森林方法来展示这些增长主要是由初始入学质量的提高所驱动的。我们的结果表明，针对大学选择的策略可能比那些仅关注可负担性的策略更有效、更高效地提高学位获得率。

---
### 像曾祖父母一样，曾孙辈也如此？美国历史上的多代际流动性
...
**摘要**: 利用1850至1940年间美国2.5百万曾孙辈与他们的曾祖父之间的数据链接，我们展示了尽管发生了重大的结构性变化，经济差距仍然在四代人之间强烈持续存在。我们发现，白人曾祖父之间经济地位的初始差异有三分之一在他们的曾孙辈中仍然存在。当包括黑人和白人家庭时，这种持续性上升到大约50%，主要是因为黑人和白人家庭之间的差距随时间缓慢缩小。祖父母和曾祖父母的地位在父亲的社会地位之外也很重要，这表明向平均水平的收敛速度比两代人估计预测的要慢。然而，这种过度的持续性主要是由持久的种族不平等驱动的，因为在白人群体内祖父母效应很小。
...
**摘要**: 近年来，田野实验已经重塑了全球的政策，但扩大理念仍然是一个棘手的挑战。也许当今政策制定者面临的最重要问题是如何决定哪些理念需要扩大规模。一种减轻这一信息问题的方法是从一开始就增强传统的A/B实验设计，以解决可扩展性问题。2024年的清单将这种方法称为“选项C”思维。以早期教育为案例研究，我们展示了人工智能如何克服选项C思维中的关键障碍——为扩大实验规模生成可行的选项。通过整合人工智能驱动的洞察力，这种方法加强了受控试验和大规模实施之间的联系，确保为有效决策提供基于政策的证据。
...
**摘要**: 我们发展并量化了一种新颖的增长理论，其中经济活动从物质生产内在地转向质量提升。消费者从具有不同环境足迹的商品中获得效用：必需品是物质密集型的且具有污染性，而奢侈品更多基于服务且排放较少。创新可以指向物质生产率或产品质量。由于对奢侈品的需求对质量更敏感，经济逐渐变得“无重量”：增长由质量提升驱动，服务业成为主导的就业部门，物质生产稳定在有限水平。这种结构性转变使得生活水平提高的同时环境强度下降，为物质产出的减增长提供了一条不损害经济进步的内在路径。政策可以加速这一转变，但其负担是不均等的，对穷人的影响比富人更大。

---
### 匹配贡献是否激励非正规工人参与退休储蓄计划？一个与自然实验相结合的随机评估
...
**摘要**: 我们在秘鲁对非正规工人进行了一项大型实地实验，研究是否提供匹配贡献能提高他们参与个人退休账户的比率和贡献额。我们有三个组别：一个对照组没有匹配，以及两个分别接受50%和100%匹配的治疗组。此外，由于时间跨度，我们还可以分析新冠疫情前后的不同反应。结果如下：首先，匹配激励增加了参与度。50%和100%匹配组的工人参与率分别比对照组高出5.2和6.5个百分点。参与效应在新冠疫情前存在，在疫情期间消失。其次，100%的匹配激励是唯一有效的激励措施，能够提高所有人（1.4个百分点）、疫情前（2.3个百分点）和疫情期间（0.97个百分点）的储蓄。这种效应在LATE（局部平均处理效应）规范中仍然存在，并且提高了更多的百分点。第三，100%的匹配再次是唯一有效的激励措施，使得人们在整个样本中（1.2个百分点）和疫情前（2.7个百分点）多次贡献，包括LATE规范（整个样本 - 5.6个百分点；疫情前 - 8.2个百分点）。第四，50%的匹配在任何规范中都没有提高贡献的效果。
...
**摘要**: 对社会安全网的研究考察了它对受益人及其家庭的影响。我们表明，这些影响不仅限于受益人的家庭。利用回归不连续设计和行政数据，我们研究了一项丹麦政策，该政策削减了难民的福利，导致受影响个体中的犯罪增加。将难民与邻居联系起来，我们发现非丹麦邻居中的犯罪增加，即使在直接影响稳定后，这种溢出效应仍然持续存在。考虑到这些溢出效应，公共资金的边际价值提高了20%。我们探索了几种机制，并发现了与来自同一国家的年轻个体之间的同伴效应一致的证据。
