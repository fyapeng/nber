...
2. **[Measuring Industrial Policy: A Text-Based Approach](https://www.nber.org/papers/w33895)**<br/>衡量产业政策：基于文本的方法
   - *Authors: Réka Juhász, Nathan J. Lane, Emily Oehlsen, Veronica C. Perez*
3. **[Abortion Restrictions and Intimate Partner Violence in the Dobbs Era](https://www.nber.org/papers/w33916)**<br/>在多布斯时代，堕胎限制与亲密伴侣暴力
   - *Authors: Dhaval M. Dave, Christine Durrance, Bilge Erten, Yang Wang, Barbara L. Wolfe*
4. **[Long-term Vertical Contracts, Geography, and the Persistence of Brand Shares](https://www.nber.org/papers/w33906)**<br/>长期纵向合同、地理因素与品牌份额的持续性
   - *Authors: Robert Clark, Jean-François Houde, Xinrong Zhu*
5. **[Growth in AI Knowledge](https://www.nber.org/papers/w33907)**<br/>人工智能知识增长
   - *Authors: Joshua S. Gans*
6. **[Labor Markets in Developing Countries](https://www.nber.org/papers/w33908)**<br/>发展中国家的劳动市场
   - *Authors: Emily Breza, Supreet Kaur*
7. **[How Does Privacy Regulation Affect Transatlantic Venture Investment? Evidence from GDPR](https://www.nber.org/papers/w33909)**<br/>隐私法规如何影响跨大西洋风险投资？来自GDPR的证据
   - *Authors: Jian Jia, Ginger Zhe Jin, Mario Leccese, Liad Wagman*
8. **[Wildfire, Smoke and Mental Health in Canada](https://www.nber.org/papers/w33912)**<br/>加拿大的野火、烟雾与心理健康
   - *Authors: Janet Currie, Soodeh Saberian*
9. **[‘Sorting’ Out Gender Discrimination and Disadvantage: Evidence from Student Evaluations of Teaching](https://www.nber.org/papers/w33911)**<br/>“筛选”性别歧视与劣势：来自学生教学评价的证据
   - *Authors: Sara Ayllón, Lars J. Lefgren, Richard W. Patterson, Olga B. Stoddard, Nicolás Urdaneta Andrade*
10. **[Efficiency in Job-Ladder Models](https://www.nber.org/papers/w33910)**<br/>工作阶梯模型中的效率
   - *Authors: Masao Fukui, Toshihiko Mukoyama*
11. **[Childless or Child-fewer? Childlessness and Parity Progression where Fertility is Below Replacement](https://www.nber.org/papers/w33913)**<br/>无子女还是子女较少？在生育率低于替代水平的情况下探讨无子女和生育进度
   - *Authors: Michael Geruso, Dean Spears*
12. **[Firm Investment and the User Cost of Capital: New U.S. Corporate Tax Reform Evidence](https://www.nber.org/papers/w33914)**<br/>公司投资与资本使用成本：美国公司税改革的新证据
   - *Authors: Jonathan S. Hartley, Kevin A. Hassett, Joshua D. Rauh*
13. **[Defaulting 401(k) Assets into Payout Annuities for “Pretty Good” Lifetime Incomes](https://www.nber.org/papers/w33915)**<br/>将401(k)资产违约为支付年金，以获得“相当不错”的终身收入
   - *Authors: Vanya Horneff, Raimond Maurer, Olivia S. Mitchell*
14. **[Nicotine Vaping and Youth Mental Health: New Evidence from E-Cigarette Regulations](https://www.nber.org/papers/w33917)**<br/>尼古丁电子烟与青少年心理健康：来自电子烟法规的新证据
   - *Authors: Chad D. Cotti, Tessie Krishna, Johanna Catherine Maclean, Erik T. Nesson, Joseph J. Sabia*
15. **[Who Benefits from Paid Family Leave? The Impact on Informal and Formal Care for Middle-Aged and Older Adults with Disabilities](https://www.nber.org/papers/w33918)**<br/>谁从带薪家庭假中受益？对中年和老年残疾人非正式和正式护理的影响
   - *Authors: Yuting Qian, Xi Chen*
16. **[Scalable Targeting of Social Protection: When Do Algorithms Out-Perform Surveys and Community Knowledge?](https://www.nber.org/papers/w33919)**<br/>可扩展的社会保护目标定位：何时算法的表现优于调查和社区知识？
   - *Authors: Emily Aiken, Anik Ashraf, Joshua Blumenstock, Raymond Guiteras, Ahmed Mushfiq Mobarak*
17. **[Bequests](https://www.nber.org/papers/w33927)**<br/>遗产
   - *Authors: Charles Yuji Horioka*
18. **[The Social Desirability Atlas](https://www.nber.org/papers/w33920)**<br/>社会期望图集
   - *Authors: Leonardo Bursztyn, Ingar K. Haaland, Nicolas Röver, Christopher Roth*
19. **[The Neoclassical Theory of Firm Investment and Taxes: A Reassessment](https://www.nber.org/papers/w33922)**<br/>新古典企业投资与税收理论：重新评估
   - *Authors: Gabriel Chodorow-Reich*
20. **[Increasing Degree Attainment Among Low-Income Students: The Role of Intensive Advising and College Quality](https://www.nber.org/papers/w33921)**<br/>提高低收入学生学位获得率：密集咨询和大学质量的作用
   - *Authors: Andrew C. Barr, Benjamin L. Castleman*
21. **[Like Great-Grandparent, Like Great-Grandchild? Multigenerational Mobility in American History](https://www.nber.org/papers/w33923)**<br/>像曾祖父母一样，曾孙辈也如此吗？美国历史上的多代际流动性
   - *Authors: Zachary Ward, Kasey Buckles, Joseph Price*
22. **[Using AI to Generate Option C Scaling Ideas: A Case Study in Early Education](https://www.nber.org/papers/w33924)**<br/>利用人工智能生成选项C扩展思路：早期教育案例研究
   - *Authors: Faith Fatchen, John A. List, Francesca Pagnotta*
23. **[A Theory of Endogenous Degrowth and Environmental Sustainability](https://www.nber.org/papers/w33634)**<br/>内生性衰退与环境可持续性理论
   - *Authors: Philippe Aghion, Timo Boppart, Michael Peters, Matthew Schwartzman, Fabrizio Zilibotti*
24. **[Does Matching Contribution Incentivize Informal Workers to Participate in Retirement Saving Plans? A Randomized Evaluation Interacted with a Natural Experiment](https://www.nber.org/papers/w33925)**<br/>匹配贡献是否激励非正规工人参与退休储蓄计划？一个与自然实验相互作用的随机评估
   - *Authors: Noelia Bernal, Sebastian Galiani, Oswaldo Molina*
25. **[Welfare Programs and Crime Spillovers](https://www.nber.org/papers/w33926)**<br/>福利计划与犯罪外溢效应
   - *Authors: David Jinkins, Elira Kuka, Claudio Labanca*
...
### 人工智能与社交媒体：政治经济学视角
**[AI and Social Media: A Political Economy Perspective](https://www.nber.org/papers/w33892)**
...
**摘要**: 我们考虑在线平台使用人工智能（AI）进行社交媒体内容传播、娱乐或电子商务的政治后果。我们确定了两个不同但互补的机制，社交媒体渠道和数字广告渠道，它们共同和单独地促成了选民的极化，进而导致政党的极化。首先，旨在最大化用户参与度的AI驱动推荐在平台上创造了回音室（或“过滤泡沫”），增加了个体不接触反态度内容的可能性。因此，社交媒体参与使选民更加极化，然后政党通过自身变得更加极化来响应。其次，我们展示了政党竞争可以鼓励平台更多地依赖针对性数字广告进行货币化（而不是基于订阅的商业模式），而这样的广告反过来又使选民更加极化，进一步促成了政党的极化。当一个政党占主导地位时，这些效应不会出现，在这种情况下，平台的利润最大化商业模式是基于订阅的。我们讨论了监管对AI驱动的在线平台极化效应的影响。

---
### 衡量产业政策：基于文本的方法
**[Measuring Industrial Policy: A Text-Based Approach](https://www.nber.org/papers/w33895)**
...
**摘要**: 自18世纪以来，政策制定者一直在讨论产业政策（IP）的优点。然而，由于测量挑战，经济学家缺乏关于其使用的基本事实。我们提出了一种基于政策文本中信息的新方法来测量IP。我们展示了如何使用现成的监督机器学习工具来大规模分类产业政策。利用这种方法，我们验证了对早期测量方法的长期担忧，这些方法将IP与其他类型的政策混为一谈。我们将我们的方法应用于全球商业政策描述的数据库，并首次在国家、行业和年份层面（2010-2022年）观察IP的使用情况。新的IP数据表明，i）IP正在上升；ii）现代IP倾向于使用补贴和出口促进措施，而不是关税；iii）富裕国家在IP使用上占据主导地位；iv）IP倾向于针对具有既定比较优势的行业，特别是在高收入国家。

---
### 在多布斯时代，堕胎限制与亲密伴侣暴力
**[Abortion Restrictions and Intimate Partner Violence in the Dobbs Era](https://www.nber.org/papers/w33916)**
...
**摘要**: 在推翻罗伊诉韦德案并触发许多州禁止或严格限制堕胎的法律后，最高法院在2022年具有里程碑意义的多布斯决定极大地改变了美国生殖健康的格局。先前的研究强调了堕胎限制对妇女和家庭的深远影响，这些影响不仅限于它们对堕胎、出生和生育能力的直接影响。我们提供了一些最早的因果证据，说明在多布斯时代之后，堕胎限制如何影响女性遭受亲密伴侣暴力（IPV）的风险。IPV是女性经历的最常见暴力形式，堕胎获取方式的变化可能会对各种输入（经济资源、压力、家庭内部议价）产生意外影响，这些影响可能会影响关系动态并增加IPV的风险。利用2017-2023年向执法部门报告的IPV事件信息，结合多布斯之后县级前往堕胎设施的旅行距离变化，分析基于广义差异-差异方法。我们发现，堕胎限制——通过增加旅行距离和存在近全面禁令来衡量——显著增加了受治疗县级生育年龄女性的IPV率，大约增加了7%到10%。这些估计意味着在受治疗的“触发禁令”州中，女性IPV事件至少增加了9,000起，预计将增加超过12.4亿美元的社会成本。

---
### 长期纵向合同、地理因素与品牌份额的持续性
**[Long-term Vertical Contracts, Geography, and the Persistence of Brand Shares](https://www.nber.org/papers/w33906)**
...
**摘要**: 先前的研究强调了不同地区国家品牌市场份额的持续差异，这些差异是由地理消费者偏好和早期进入优势所驱动的（Bronnenberg等人，2007年，2009年）。本研究调查了长期垂直合同在多大程度上可以解释观察到的地理分布和国家品牌主导地位的持续性。使用与Bronnenberg等人（2007年）相同产品类别的NielsenIQ数据，我们遵循Abowd等人（1999年）的方法，将品牌份额的方差分解为品牌×零售商和品牌×市场效应。结果显示，50%的方差是由零售商效应解释的，而市场效应解释了20%。这表明一些零售商使用垂直合同来支持他们在所有竞争市场中的特定品牌，例如独家交易、上架费或品类船长合同，这些在维持先前文献中记录的国家品牌主导地位中发挥了关键作用。通过强调零售商特定因素如何驱动观察到的模式，我们补充了需求侧解释，并将注意力转移到可能影响竞争的供给侧因素上。

---
### 人工智能知识增长
**[Growth in AI Knowledge](https://www.nber.org/papers/w33907)**
...
**摘要**: 在近期关于知识创造和创新的文献进展（特别是Carnehl和Schneider（2025））的基础上，我们提出了一个新颖的一般均衡模型，该模型明确将人工智能（AI）纳入作为一个能够插值已知知识点之间空白的决策增强技术。我们的框架形式化了AI覆盖范围——其跨越更广泛知识差距的能力——与其准确性之间的权衡，并揭示了一个令人惊讶的结果：除了产生直接的生产力增长外，AI从根本上改变了研究的新颖性。具体来说，当AI系统提供足够广泛的覆盖范围时，它们激励了探索性研究，这些研究触及新颖、遥远的知识领域，并加速了长期增长；相反，有限的覆盖范围促进了可能提高短期效率但抑制新思想整体发展的增量研究。此外，我们的分析揭示了知识类型——无论是新颖的还是密集的——在决定AI的增长和福利影响方面发挥着关键作用，为理解知识如何影响研究策略开辟了新路径。通过同样检查市场结构、许可安排和监管框架的作用，我们的工作提供了新的、与政策相关的见解，这些见解协调了AI采纳的即时利益与可持续长期经济增长的需求。

---
### 发展中国家的劳动市场
**[Labor Markets in Developing Countries](https://www.nber.org/papers/w33908)**
...
**摘要**: 发展过程中伴随着劳动力市场结构的显著变化。我们列出了一系列区分发展中国家劳动力市场与富裕国家劳动力市场的典型特征。我们的回顾围绕一个特别引人注目的差异展开：在贫穷国家，工作年龄的个体只有20-50%的时间从事有薪工作。有证据表明，这种低薪就业反映了高比例的非自愿失业（常常被自雇掩盖），以及工资刚性、市场力量和搜索与匹配摩擦等摩擦。同时，越来越多的文件记录显示，工人更倾向于自雇或失业，而不是选择许多可供他们选择的有薪工作，尤其是正规部门的低技能工作。我们提供了一些证据，说明贫困本身如何抑制劳动力供给，使得“低”劳动力供给本身可能是欠发展的一个结果。在我们的回顾中，我们强调了贫困的三个核心方面——市场的缺失、社会联系的重要性和制度的不规则性——对于理解发展中国家劳动力市场为何可能与富裕国家的劳动力市场表现不同是重要的。这对于理解劳动力市场如何响应发展过程，并帮助促进发展过程具有相关性。

---
### 隐私法规如何影响跨大西洋风险投资？来自GDPR的证据
**[How Does Privacy Regulation Affect Transatlantic Venture Investment? Evidence from GDPR](https://www.nber.org/papers/w33909)**
...
**摘要**: 我们研究了GDPR如何影响跨大西洋的风险投资。通过分析2014年至2019年的投资数据，我们发现2018年5月GDPR的实施导致美国投资者在欧盟的活动显著减少，表现为交易和投资减少，尤其是对于较新的和与数据相关的企业。投资者转向地理上更接近的企业，并更多地依赖于联合投资，特别是与欧盟的领投投资者合作。尽管转向本地投资推动了整体的下降，但联合投资部分抵消了这一趋势。研究结果突显了数字政策在塑造投资策略和影响跨大西洋资本流动中的作用。

---
### 加拿大的野火、烟雾与心理健康
**[Wildfire, Smoke and Mental Health in Canada](https://www.nber.org/papers/w33912)**
...
**摘要**: 本研究考察了2006年至2018年间加拿大野火与心理健康相关住院之间的关系。大多数先前对野火心理健康成本的估计都集中在暴露于PM₂.₅的影响上。我们通过强调野火影响心理健康的其他途径，包括疏散命令、火灾的直接本地成本和气候焦虑（使用与野火相关的Twitter活动作为代理），从而开辟了新的研究领域。我们发现，所有这些机制都影响心理健康相关的住院，特别是对焦虑和药物滥用的住院影响尤为显著。在空气质量条件受限的情况下，引起全国关注的野火事件会恶化易感人群的心理健康，即使他们居住在远离野火的地方。老年人和那些有先前健康状况使他们更脆弱的人，受到的影响更大。结果表明，由野火事件引发的气候焦虑可能占整体心理健康成本的很大一部分。然而，考虑到这些额外机制对PM₂.₅从野火烟雾中的估计效应几乎没有减弱，这表明这些额外因素对心理健康的影响是除了PM₂.₅之外的。

---
### “筛选”性别歧视与劣势：来自学生教学评价的证据
**[‘Sorting’ Out Gender Discrimination and Disadvantage: Evidence from Student Evaluations of Teaching](https://www.nber.org/papers/w33911)**
...
**摘要**: 当更具歧视性和不那么慷慨的学生系统性地选择某些领域、课程和教师的课时，应该如何解决性别歧视和系统性劣势问题？在本文中，我们通过检查学生对男性和女性教师的评价差异，控制教授固定效应，来估计学生层面的性别偏见和评价慷慨度的度量。考虑到测量误差，我们发现学生间的性别偏见和慷慨度存在显著差异。此外，我们发现偏见根据性别和学习领域系统性变化，并且排序模式足够大，以至于在某些领域使女性教师处于实质性劣势，而在其他领域使男性教师处于劣势。最后，我们记录了性别歧视态度可以预测基于性别的排序，并提出了受经验贝叶斯启发的学生层面偏见度量方法，以纠正由排序引起的教师特定优势和劣势。

---
### 工作阶梯模型中的效率
**[Efficiency in Job-Ladder Models](https://www.nber.org/papers/w33910)**
...
**摘要**: 本文考察了在广泛的随机搜索工作阶梯模型中，去中心化均衡的效率。我们将效率低下的来源分解为两个方面：（i）投资边际，即在给定匹配剩余的情况下，创造就业的私人和社会利益之间的差异；（ii）估值边际，即私人估值和社会估值之间对匹配剩余的差异。在存在在职搜索的情况下，众所周知的Hosios条件不再保证市场均衡与有效配置在这两个方面保持一致。在职搜索导致市场均衡中对匹配剩余的高估，特别是在工作阶梯的顶端。因此，在Hosios条件下的去中心化均衡特征是，在稳态中存在过多的职位空缺创造。在职搜索还导致在应对总体生产率冲击时，失业率的过度波动。从数量上看，我们发现在标准校准下，均衡结果与有效配置之间存在显著差异。我们还考虑了几种有效配置的去中心化，以阐明在摩擦性劳动市场中的最佳政策。

---
### 无子女还是子女较少？在生育率低于替代水平的情况下探讨无子女和生育进度
**[Childless or Child-fewer? Childlessness and Parity Progression where Fertility is Below Replacement](https://www.nber.org/papers/w33913)**
...
**摘要**: 全球的出生率都在下降，每个地区都不例外。下降的出生率可以分解为两个组成部分：（1）无子女现象的增加（即终身未生育），以及（2）至少生育一个孩子的女性所生育的孩子数量减少（已生育女性的完成队列生育率）。本文量化了这两个组成部分对欧洲、北美和南美以及东南亚的发达经济体中的女性，以及印度各区近期队列的贡献。在两个样本中，我们都发现，已生育女性的生育率是解释低总体出生率的一个重要组成部分。在我们的分析中，无子女现象仅解释了发达经济体队列生育率下降的38%。在印度背景下，无子女现象仅占高生育率与低于替代水平地区之间差异的6%。此外，在许多国家队列和印度地区，即使只考虑有孩子的女性，即从平均数中省略零值，平均完成的队列生育率也会低于替代阈值。这与广泛流传的近期叙述相矛盾，这些叙述将出生率下降归因于无子女现象的增加：相反，在许多人群中，即使是父母的平均水平生育率也足以最终导致人口减少。

---
### 公司投资与资本使用成本：美国公司税改革的新证据
**[Firm Investment and the User Cost of Capital: New U.S. Corporate Tax Reform Evidence](https://www.nber.org/papers/w33914)**
...
**摘要**: 2017年的《减税与就业法案》（TCJA）标志着三十年来美国公司税法首次进行了实质性的修改。我们利用TCJA作为一个准自然实验，来估计资本使用成本变化对投资的影响。遵循Auerbach和Hassett（1991年）的方法，我们使用横截面数据发现，资本使用成本与更高的投资率相关，这与之前的研究一致。在2017年TCJA之后，美国经济分析局（BEA）的资产类型中，资本使用成本和边际有效税率（METR）降低幅度更大的那些，在税改几年后其投资率的增长在统计上更为显著。具体来说，我们发现资本使用成本每降低1个百分点，与投资率增加1.68至3.05个百分点相关，这比之前对投资对资本使用成本反应敏感性的估计要大。

---
### 将401(k)资产违约为支付年金，以获得“相当不错”的终身收入
**[Defaulting 401(k) Assets into Payout Annuities for “Pretty Good” Lifetime Incomes](https://www.nber.org/papers/w33915)**
...
**摘要**: 一些美国的固定缴款计划为退休人员提供了从他们的401(k)账户中选择年金或终身收入流作为支付选项。然而，由于行为原因，一些退休人员可能会犹豫选择终身收入流作为提取工具。为了解决这个问题，计划发起人可以自动将退休人员的401(k)资产的一部分分配给年金，因为现在这样做的监管障碍已经减少。我们使用生命周期经济模型来评估将退休人员的401(k)资产默认为支付年金的利弊。我们展示，将退休人员资产的20%超过一定阈值的部分默认为立即年金，可以增强大多数计划参与者的退休安全性。对于大学毕业生来说，推迟到80岁开始的年金尤其有益，这在提高他们的福利方面是特别有益的。

---
### 尼古丁电子烟与青少年心理健康：来自电子烟法规的新证据
**[Nicotine Vaping and Youth Mental Health: New Evidence from E-Cigarette Regulations](https://www.nber.org/papers/w33917)**
...
**摘要**: 青少年心理健康危机与高比率的青少年尼古丁电子烟使用相结合，导致一些美国烟草控制倡导者认为，通过政策如电子尼古丁输送系统(ENDS)征税来减少接触ENDS，可能会改善青少年和年轻成年人的心理健康。利用来自几个全国代表性调查（青少年风险行为调查、行为风险因素监测系统和烟草与健康人口评估）的数据和广义差异-差异方法，我们发现没有证据表明ENDS征税改善了青少年和年轻成年人的心理健康。我们有95%的信心排除这种可能性，即在我们分析样本中采用的平均州ENDS税收增加（2023年每毫升电子液体0.34美元）将青少年持续抑郁症状减少超过0.3%，自杀念头减少超过1.0%。此外，离散时间风险模型几乎没有证据表明ENDS税收影响青少年心理健康的动态。当我们检查更广泛的ENDS法规时，类似的结果模式出现，包括最低法定购买年龄、电子烟许可法、在线销售限制和室内尼古丁电子烟限制。

---
### 谁从带薪家庭假中受益？对中年和老年残疾人非正式和正式护理的影响
**[Who Benefits from Paid Family Leave? The Impact on Informal and Formal Care for Middle-Aged and Older Adults with Disabilities](https://www.nber.org/papers/w33918)**
...
**摘要**: 本文分析了美国带薪家庭假（PFL）政策对中年及老年残疾人非正式和正式护理的影响，以及不同家庭如何获得不同的福利。我们使用了1998-2018年健康和退休研究（HRS）的数据，并利用加利福尼亚州（2004年）、新泽西州（2009年）和纽约州（2018年）实施的PFL计划，在差异中的差异（DiD）设计中。我们既采用了传统的双向固定效应（TWFE）模型，也采用了Sun和Abraham为交错推出设计开发的适应性DiD估计器。我们发现，PFL的获取与残疾人从子女那里获得非正式护理的可能性增加了5.7个百分点有关。我们还展示了PFL的获取显著增加了家庭护理服务和养老院护理的使用。这些影响主要集中在既有配偶又有子女的残疾人中，而在只有子女没有配偶的人中几乎不存在。我们的发现表明，PFL政策改善了护理获取，并帮助解决了中年和老年残疾人未满足的护理需求，但对某些弱势群体，特别是只有子女的人，其影响仍然有限。

---
### 可扩展的社会保护目标定位：何时算法的表现优于调查和社区知识？
**[Scalable Targeting of Social Protection: When Do Algorithms Out-Perform Surveys and Community Knowledge?](https://www.nber.org/papers/w33919)**
...
**摘要**: 大数据和算法的创新正在使大规模针对性干预的新方法成为可能。我们比较了三种不同的系统在识别贫困人群以接受福利转移方面的准确性——代理手段测试、社区成员提名，以及使用机器学习预测贫困的算法方法，该方法基于移动电话使用行为——并研究它们的成本效益如何随着项目规模和范围的变化而变化。我们收集了孟加拉国所有主要电信运营商的移动电话记录，并进行了基于社区的财富排名和对5000户家庭的详细消费调查，以从106000个列出的家庭中选择22000个最贫困的家庭，为他们提供300美元的转移支付。虽然代理手段测试最准确，但在需要筛选大量家庭的国家规模项目中，算法定位变得更加具有成本效益。我们使用多哥的调查数据和移动电话记录数据，以及世界银行关于福利转移项目的跨国信息，探索这些见解的外部有效性。

---
### 遗产
**[Bequests](https://www.nber.org/papers/w33927)**
...
**摘要**: 在本文中，我们讨论了遗产和其他代际转移以及它们对家庭的消费、储蓄和劳动力供应行为的影响。我们展示了遗产和其他代际转移在大多数国家普遍存在，它们有时是出于利他主义动机，有时是出于自私动机，它们在一定程度上影响家庭的消费和储蓄行为，特别是对老年家庭的影响，它们影响家庭的劳动力供应行为，尤其是遗产接受者的行为，并且它们具有重要的政策含义。

---
### 社会期望图集
**[The Social Desirability Atlas](https://www.nber.org/papers/w33920)**
...
**摘要**: 社会期望偏差（SDB）是对调查和实验数据有效性的普遍威胁。受访者可能会经常误报敏感的态度和行为，以显得更符合社会接受度。我们首先综合实证证据，分析SDB在各个领域的普遍性和程度，重点关注具有个体水平基准的研究。然后，我们批判性地评估常用的减轻SDB的策略，强调它们有时如何因造成混乱或无意中增加感知的敏感性而失败。为了帮助研究人员应对这些挑战，我们提供实用的指导，以选择不同研究环境中最合适的工具。最后，我们检查SDB如何在实验中扭曲治疗效果，并讨论减轻策略。

---
### 新古典企业投资与税收理论：重新评估
**[The Neoclassical Theory of Firm Investment and Taxes: A Reassessment](https://www.nber.org/papers/w33922)**
...
**摘要**: 经济学家对于公司税收如何影响总体投资、产出和工资的看法大相径庭。这种分歧反映了60年来对新古典投资理论的误用历史，该理论被用来解释实证工作并指导政策分析。在本文中，我通过新古典理论的视角重新审视了与税收政策相关的企业投资累积证据。实证工作表明，企业层面、短期内投资与资本比率对用户成本的半弹性范围为-0.25至-0.75。这个范围的中点转化为企业收入对资本的弹性值在0.22到0.35之间。隐含的一般均衡、长期资本对用户成本的弹性可能与主要政策模型大相径庭。工资对用户成本的弹性范围从-0.3到-0.7，或者仅针对C型公司部门用户成本变化时，范围从-0.1到-0.2。在2024年美国相对较低的税收制度下，新古典理论对更高资本带来更高产出的贡献无法合理化通过进一步降低公司税收而获得的适度动态税收收入抵消。

---
### 提高低收入学生学位获得率：密集咨询和大学质量的作用
**[Increasing Degree Attainment Among Low-Income Students: The Role of Intensive Advising and College Quality](https://www.nber.org/papers/w33921)**
...
**摘要**: 大学学位为低收入学生提供了一条经济流动性的途径。通过使用多地点随机对照试验以及行政和调查数据，我们证明在高中和大学期间的密集咨询显著提高了低收入学生的学士学位获得率。我们利用关于咨询前大学偏好的独特数据和因果森林方法来展示这些增长主要是由初始入学质量的提高所驱动的。我们的结果表明，针对大学选择的策略可能是比那些仅关注可负担性的策略更有效和高效的提高学位获得率的手段。

---
### 像曾祖父母一样，曾孙辈也如此吗？美国历史上的多代际流动性
**[Like Great-Grandparent, Like Great-Grandchild? Multigenerational Mobility in American History](https://www.nber.org/papers/w33923)**
...
**摘要**: 利用1850至1940年间美国2.5百万曾孙辈与他们的曾祖父相关联的数据，我们展示了尽管经历了重大的结构性变化，经济差距在四代人之间仍然强烈存在。我们发现，白人曾祖父之间经济地位的初始差异有三分之一在其曾孙辈中仍然存在。当包括黑人和白人家庭时，这种持续性上升到大约50%，主要是因为黑人和白人家庭之间的差距随时间缓慢缩小。祖父母和曾祖父母的地位超越了父亲的地位，表明向平均水平的收敛速度比两代人估计预测的要慢。然而，这种过度的持续性主要是由持续的种族不平等驱动的，因为在白人群体内祖父母效应很小。

---
### 利用人工智能生成选项C扩展思路：早期教育案例研究
**[Using AI to Generate Option C Scaling Ideas: A Case Study in Early Education](https://www.nber.org/papers/w33924)**
...
**摘要**: 近年来，田野实验重塑了全球政策，但扩大理念仍然是一个棘手的挑战。或许决策者今天面临的最重要问题是如何决定哪些理念需要扩大。为了减轻这一信息问题，一种方法是从一开始就增强传统的A/B实验设计，以解决可扩展性问题。2024年的列表将这种方法称为“选项C”思维。以早期教育为案例研究，我们展示了人工智能如何克服选项C思维中的一个关键障碍——为扩大实验生成可行的选项。通过整合人工智能驱动的洞察，这种方法加强了受控试验与大规模实施之间的联系，确保为有效决策产生基于政策的证据。

---
### 内生性衰退与环境可持续性理论
**[A Theory of Endogenous Degrowth and Environmental Sustainability](https://www.nber.org/papers/w33634)**
...
**摘要**: 我们发展并量化了一种新颖的增长理论，其中经济活动从物质生产内生地转向质量提升。消费者从具有不同环境足迹的商品中获得效用：必需品是物质密集型的且污染严重，而奢侈品更多基于服务且排放较少。创新可以指向物质生产率或产品质量。由于对奢侈品的需求对质量更敏感，经济逐渐变得“无重量”：增长由质量提升驱动，服务业成为主要的就业部门，物质生产稳定在一个有限的水平。这种结构性转变使得生活水平提高与环境强度下降并存，提供了一种内生的物质产出减少的路径，而不影响经济进步。政策可以加速这一转变，但其负担是不均匀的，对穷人的影响比对富人更大。

---
### 匹配贡献是否激励非正规工人参与退休储蓄计划？一个与自然实验相互作用的随机评估
**[Does Matching Contribution Incentivize Informal Workers to Participate in Retirement Saving Plans? A Randomized Evaluation Interacted with a Natural Experiment](https://www.nber.org/papers/w33925)**
...
**摘要**: 我们在秘鲁对非正规工人进行了一项大型现场实验，研究是否提供匹配贡献能提高他们参与个人退休账户的比例和贡献额。我们有三个组：一个对照组没有匹配，两个处理组分别接受50%和100%的匹配。此外，由于时间跨度，我们还可以分析新冠疫情前后的不同反应。结果如下。首先，匹配激励增加了参与度。50%和100%匹配组的工人参与率分别比对照组高5.2和6.5个百分点。参与效应在新冠疫情前存在，在疫情期间消失。其次，100%的匹配激励是唯一有效的提高所有人储蓄的手段（1.4个百分点），疫情前（2.3个百分点）和疫情期间（0.97个百分点）。这种效应在LATE（局部平均处理效应）规范中仍然存在，且个百分点更高。第三，100%匹配再次是唯一有效的手段，使得人们在完整样本中（1.2个百分点）和疫情前（2.7个百分点）多次贡献，包括LATE规范（完整样本-5.6个百分点；疫情前-8.2个百分点）。第四，50%匹配在任何规范中都未能提高贡献。

---
### 福利计划与犯罪外溢效应
**[Welfare Programs and Crime Spillovers](https://www.nber.org/papers/w33926)**
...
**摘要**: 对社会安全网的研究考察了它对接受者及其家庭的影响。我们展示这些影响不仅限于接受者的家庭。利用回归不连续设计和行政数据，我们研究了丹麦的一项政策，该政策削减了难民的福利，增加了受影响个体的犯罪行为。将难民与邻居联系起来，我们发现非丹麦邻居中的犯罪增加，即使在直接影响稳定后，这种溢出效应仍然持续存在。考虑到这些溢出效应，公共资金的边际价值提高了20%。我们探索了几种机制，并发现了与来自同一国家的年轻个体之间的同伴效应一致的证据。
